...
dinosaurs = [
    {name: "Judith", description: "tyrannosaurus", age: 33, origin: "Brazil", bio: "The friendliest T-Rex in town, Judith loves soaking up the sunshine in St. James's Park and eating frozen ice bones. Great with people but watch out, she loves to play pranks!", diet: "carnivorous", daily_rate: 100, user: User.all.sample},
    ...
    {name: "Soph", description: "brachiosaurus", age: 60, origin: "Ghana", bio: "Soph is a 5* performer, she's been in every Jurassic Park movie and loves attending premiers and parties. Adores classical music. Vegan.", diet: "herbivorous", daily_rate: 1500, user: User.all.sample},
    {name: "Amanda", description: "stegosaurus", age: 62, origin: "Australia", bio: "Need anything demolishing or moving? Amanda is a skilled at big jobs. Super friendly, full of energy and loves frozen watermelon.", diet: "herbivorous", daily_rate: 300, user: User.all.sample},
    ...
    {name: "Edward", description: "iguanodon", age: 63, origin: "UK", bio: "Edward is lovely companion - great for helping with errands, particularly gentle with children and mature adults. Very handy in the garden too!", diet: "herbivorous", daily_rate: 75, user: User.all.sample},
    {name: "Olivia", description: "iguanodon", age: 22, origin: "UK", bio: "Need a babysitter? Olivia is incredible with children and pets. Very experienced house sitter, great with people but not friendly with other dinosaurs. Loves Earl Grey tea and cucumber sandwiches.", diet: "herbivorous", daily_rate: 80, user: User.all.sample},
