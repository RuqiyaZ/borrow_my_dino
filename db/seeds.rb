...
dinosaurs = [
    ...
    {name: "Olivia", description: "iguanodon", age: 22, origin: "UK", bio: "Need a babysitter? Olivia is incredible with children and pets. Experienced house sitter but not keen on other dinosaurs. Loves Earl Grey tea and cucumber sandwiches.", diet: "herbivorous", daily_rate: 80, user: User.all.sample},
